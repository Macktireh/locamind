...
class Property(BaseModel):
    landlord = models.ForeignKey(verbose_name=_("landlord"), to=Landlord, on_delete=models.CASCADE, related_name="properties")
    ...
    frequency = models.CharField(
        verbose_name=_("Payment Frequency"), choices=PaymentFrequencyChoice.choices, max_length=255, blank=True, null=True
    )
