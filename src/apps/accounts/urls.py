...
from apps.accounts.views.login_with_google_view import SignInWithGoogleView
...
urlpatterns = [
    ...
    path(route="login/google/callback/", view=SignInWithGoogleView.as_view(), name="login_with_google"),
