...
from bienlocation.apps.common.exceptions import ApplicationError
from bienlocation.apps.common.services import model_update
from bienlocation.apps.common.types import EmailDataType
from bienlocation.apps.core.models.email_models import Email
